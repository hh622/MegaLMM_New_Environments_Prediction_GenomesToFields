# =============================================
# scriptFigure05_ECs_Improve_GP_in_NewEnv
# =============================================
...
DIR_Output="../Figure05_ECs_Improve_GP_NewEnv/"
...
res_meta_btw_Scn=foreach(TraitName = unique(res[[1]]$TraitName),.combine = "rbind") %do% {
  foreach(CVScn = names(res), .combine = "rbind") %do%{
    ...
    if(CVScn=="CV3NewTrial"){
      # average cor across five CV2 Folds
      res_tmp = aggregate(cbind(CV3NewTrial_GBLUP_O_O_cor,
                                CV3NewTrial_O_O_cor,
                                CV3NewTrial_ST_O_cor,
                                CV3NewTrial_ST_ST_cor,
                                CV3NewTrial_GBLUP_O_O_vs_O_O_cor,
                                CV3NewTrial_O_O_vs_ST_O_cor,
                                CV3NewTrial_ST_O_vs_ST_ST_cor)~TraitName+
                            CVScn+EnvName,
                          data = res_tmp,FUN = mean, na.rm=T)
      # add NumObs_Env
      ...
      # - CV3NewTrial meta analysis between scenarios: 
      #   - compare O::O vs S+T::O
      #   - compare S+T::O vs S+T::T
      #   - compare W+T::W+T vs W+K::W+K
      df_CV3NewTrial_GBLUP_O_O_vs_O_O=
        meta_comp_res(r12=res_tmp$CV3NewTrial_O_O_cor,
                      r13=res_tmp$CV3NewTrial_GBLUP_O_O_cor,
                      r23=res_tmp$CV3NewTrial_GBLUP_O_O_vs_O_O_cor,
                      n=res_tmp$NumObs_Env,
                      PriorPredMode1="GBLUP_O::O",
                      PriorPredMode2="O::O"
        )
      df_CV3NewTrial_ST_O_vs_O_O=
        meta_comp_res(r12=res_tmp$CV3NewTrial_ST_O_cor,
                      r13=res_tmp$CV3NewTrial_O_O_cor,
                      r23=res_tmp$CV3NewTrial_O_O_vs_ST_O_cor,
                      n=res_tmp$NumObs_Env,
                      PriorPredMode1="O::O",
                      PriorPredMode2="S+T::O"
        )
      df_CV3NewTrial_ST_ST_vs_ST_O=
        meta_comp_res(r12=res_tmp$CV3NewTrial_ST_ST_cor,
                      r13=res_tmp$CV3NewTrial_ST_O_cor,
                      r23=res_tmp$CV3NewTrial_ST_O_vs_ST_ST_cor,
                      n=res_tmp$NumObs_Env,
                      PriorPredMode1="S+T::O",
                      PriorPredMode2="S+T::T")
      df = rbind(df_CV3NewTrial_GBLUP_O_O_vs_O_O,df_CV3NewTrial_ST_O_vs_O_O,df_CV3NewTrial_ST_ST_vs_ST_O)
    }else if(CVScn=="CV3NewState"){
      # average cor across five CV2 Folds
      res_tmp = aggregate(cbind(CV3NewState_GBLUP_O_O_cor,
                                CV3NewState_O_O_cor,CV3NewState_ST_O_cor,
                                CV3NewState_GBLUP_O_O_vs_O_O_cor,CV3NewState_O_O_vs_ST_O_cor,
      ...
      #   - compare S+T::O vs S+T::T
      #   - compare W+T::W+T vs W+K::W+K
      df_CV3NewState_GBLUP_O_O_vs_O_O=
        meta_comp_res(r12=res_tmp$CV3NewState_O_O_cor,
                      r13=res_tmp$CV3NewState_GBLUP_O_O_cor,
                      r23=res_tmp$CV3NewState_GBLUP_O_O_vs_O_O_cor,
                      n=res_tmp$NumObs_Env,
                      PriorPredMode1="GBLUP_O::O",
                      PriorPredMode2="O::O"
        )
      ...
      df = rbind(df_CV3NewState_GBLUP_O_O_vs_O_O,
                 df_CV3NewState_ST_O_vs_O_O,df_CV3NewState_ST_T_vs_ST_O,
                 df_CV3NewState_WT_WT_vs_ST_T,df_CV3NewState_WT_WT_vs_WK_WK)
    }else if(CVScn=="CV3NewTester"){
      # average cor across CV2 Folds
      res_tmp = aggregate(cbind(CV3NewTester_GBLUP_O_O_cor,
                                CV3NewTester_O_O_cor,CV3NewTester_ST_O_cor,
                                CV3NewTester_GBLUP_O_O_vs_O_O_cor,CV3NewTester_O_O_vs_ST_O_cor,
      ...
      df_CV3NewTester_GBLUP_O_O_vs_O_O=
        meta_comp_res(r12=res_tmp$CV3NewTester_O_O_cor,
                      r13=res_tmp$CV3NewTester_GBLUP_O_O_cor,
                      r23=res_tmp$CV3NewTester_GBLUP_O_O_vs_O_O_cor,
                      n=res_tmp$NumObs_Env,
                      PriorPredMode1="GBLUP_O::O",
                      PriorPredMode2="O::O"
        )
      ...
      df_CV3NewTester_SK_SK_vs_WK_WK=
        meta_comp_res(r12=res_tmp$CV3NewTester_SK_SK_cor,
                      ...
                      PriorPredMode2="W+K::W+K")
      df = rbind(df_CV3NewTester_GBLUP_O_O_vs_O_O,
                 df_CV3NewTester_ST_O_vs_O_O,df_CV3NewTester_ST_S_vs_ST_O,
...
unique(res_meta_btw_Scn$PriorPredMode1)
...
resPlot$PriorPredModel[resPlot$PriorPredModel=="State+Tester::State+Tester"]="S+T::S+T"
...
PriorPredModel_All=c("GBLUP_O::O","O::O","S+T::O","S+T::S+T","S+T::T","S+T::S")
# ------------------------------------------------------------------------------
# plot resPlot_NewTrial
# PriorPredModel_Sel=c("S+T::T","W+T::W+T","W+K::W+K")
PriorPredModel_Sel=c("GBLUP_O::O","O::O","S+T::O","S+T::S+T")
resPlot_NewTrial = resPlot[resPlot$CVScn=="NewTrial" &
                             resPlot$PriorPredModel %in% PriorPredModel_Sel,]
# factorization
unique(resPlot_NewTrial$PriorPredModel)
resPlot_NewTrial$PriorPredModel=factor(resPlot_NewTrial$PriorPredModel,
                                       levels = unique(resPlot_NewTrial$PriorPredModel))
# get plot data
plot=ggplot(resPlot_NewTrial, 
            aes(x = TraitName, y = cor_mean_meta,fill=PriorPredModel)) +
  geom_bar(position="dodge", stat="identity")
(plot_data <- data.frame(ggplot_build(plot)$data))
resPlot_NewTrial = cbind(resPlot_NewTrial,plot_data)
head(resPlot_NewTrial)
plot_data
...
df_segments_horiz = data.frame(idx_xstart=idx_xstart,
                               idx_xend=idx_xend,
                               xstart=resPlot_NewTrial$x[idx_xstart],
                               xend=resPlot_NewTrial$x[idx_xend],
                               ystart=apply(cbind(resPlot_NewTrial$upper.CL[idx_xstart],
                                                  resPlot_NewTrial$upper.CL[idx_xend]),1,max)+
                                 segments_padding, 
                               yend=apply(cbind(resPlot_NewTrial$upper.CL[idx_xstart],
                                                resPlot_NewTrial$upper.CL[idx_xend]),1,max)+
                                 segments_padding)
df_segments_left_tip = data.frame(idx_xstart=idx_xstart,
                                  idx_xend=idx_xend,
                                  xstart=resPlot_NewTrial$x[idx_xstart],
                                  xend=resPlot_NewTrial$x[idx_xstart],
                                  ystart=apply(cbind(resPlot_NewTrial$upper.CL[idx_xstart],
                                                     resPlot_NewTrial$upper.CL[idx_xend]),1,max)+
                                    segments_padding, 
                                  yend=apply(cbind(resPlot_NewTrial$upper.CL[idx_xstart],
...
df_segments_right_tip = data.frame(idx_xstart=idx_xstart,
                                   idx_xend=idx_xend,
                                   xstart=resPlot_NewTrial$x[idx_xend],
                                   xend=resPlot_NewTrial$x[idx_xend],
                                   ystart=apply(cbind(resPlot_NewTrial$upper.CL[idx_xstart],
                                                      resPlot_NewTrial$upper.CL[idx_xend]),1,max)+
                                     segments_padding, 
...
df_pval = res_meta_btw_Scn[res_meta_btw_Scn$CVScn=="CV3NewTrial"&
                             res_meta_btw_Scn$PriorPredMode1 %in%PriorPredModel_Sel[1:3],]
...
# plot pars
errorbarwidth=as.numeric(resPlot_NewTrial$xmax-resPlot_NewTrial$xmin)[1]/5
padding=0.02
head(resPlot_NewTrial)

unique(resPlot$PriorPredModel)

# convert resPlot_NewTrial$PriorPredModel to factor
resPlot_NewTrial$PriorPredModel=factor(resPlot_NewTrial$PriorPredModel,
                                       levels = PriorPredModel_All)
plot_NewTrial=
  ggplot(resPlot_NewTrial, 
         aes(x = TraitName, y = cor_mean_meta,
             fill=PriorPredModel)) +
  labs(y = "cor")+
  geom_bar(position="dodge2", stat="identity")+
  # scale_fill_manual(name = PriorPredModel,
  #                   values = hue_pal()(6)[1:4])+
  scale_fill_manual( #name = 'PriorPredModel', 
                     values = c("GBLUP_O::O"=hue_pal()(6)[1],
                                "O::O"=hue_pal()(6)[2],
                                "S+T::O"=hue_pal()(6)[3],
                                "S+T::S+T"=hue_pal()(6)[4]
                                # "S+T::T"=hue_pal()(6)[5],
  ...
  annotate(geom="text", x=resPlot_NewTrial$x,
           y=0-padding,
           label=sprintf("%.3f",resPlot_NewTrial$cor_mean_meta))+
...
# Create a df for Adding segments between the first and second boxplots within each group
segments_vertical_len=0.01
# segments_padding=c(0.02,0.02,0.037,0.02, # adjust y posi of individual segments
#                    0.02,0.035,0.02,0.02,
#                    0.02,0.02,0.038,0.02)-0.005
segments_padding=c(0.02,0.02,0.02, # adjust y posi of individual segments
                   0.02,0.02,0.02,
                   0.02,0.022,0.02)-0.005
...
ggplot(resPlot_NewState, 
  ...
  labs(y = "cor")+
  geom_bar(position="dodge2", stat="identity")+
  # scale_fill_manual(values = hue_pal()(6)[c(1:3,5)])+
  scale_fill_manual( #name = 'PriorPredModel', 
                     values = c("GBLUP_O::O"=hue_pal()(6)[1],
                                "O::O"=hue_pal()(6)[2],
                                "S+T::O"=hue_pal()(6)[3],
...
# PriorPredModel_Sel=c("S+T::S","S+K::S+K","W+K::W+K")
PriorPredModel_Sel=c("GBLUP_O::O","O::O","S+T::O","S+T::S")
...
resPlot_NewTester$PriorPredModel=factor(resPlot_NewTester$PriorPredModel,
                                        levels = unique(resPlot_NewTester$PriorPredModel))
# get plot data
...
segments_padding=c(0.019,0.023,0.035, # adjust y posi of individual segments
                   0.02,0.035,0.02,
                   0.02,0.025,0.04)-0.005
pval_padding=0.01
idx_xstart=c(1:3,1:3+4,1:3+8)
idx_xend  =c(1:3,1:3+4,1:3+8)+1
...
ggplot(resPlot_NewTester, 
  ...
  labs(y = "cor")+
  geom_bar(position="dodge2", stat="identity")+
  # scale_fill_manual(values = hue_pal()(6)[c(1:3,6)])+
  scale_fill_manual( #name = 'PriorPredModel', 
                     values = c("GBLUP_O::O"=hue_pal()(6)[1],
                                "O::O"=hue_pal()(6)[2],
                                "S+T::O"=hue_pal()(6)[3],
...
# output in pdf
figure=
  ggpubr::ggarrange(plot_NewTrial+rremove("y.title")+
                           annotate(geom="text", x=as.numeric(plot_data$xmin[1]), 
                                    y=0.60-0.02, label="NewTrial",color="black",cex=4.5,
                                    hjust=0,vjust=0)+
                      theme(legend.justification = "bottom",
                            # legend.direction="horizontal"
                            ),
                    # guides(fill = guide_legend(nrow = 1)),
                         plot_NewState+rremove("y.title")+
                           annotate(geom="text", x=as.numeric(plot_data$xmin[1]), 
                                    y=0.60-0.01, label="NewState",color="black",cex=4.5,
                                    hjust=0,vjust=0)+
                      theme(legend.justification = "bottom",
                            # legend.direction="horizontal"
                      ),
...
(figure_caption=sprintf("%s%s_Figure05_ECs_Improve_GP_in_NewEnv_LegendRight.pdf",DIR_Output,Date))
pdf(figure_caption,width = 9, height = 9)
print(
