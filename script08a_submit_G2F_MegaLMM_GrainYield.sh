...
# run array jobs
# sbatch --array=1-10 script08_submit_G2F_MegaLMM.sh Yield_Mg_ha Wea CV3NewState 1
# sbatch --array=1-10 script08_submit_G2F_MegaLMM.sh Yield_Mg_ha Wea+TesterGRM CV3NewState 1
