# =================================================================
# script07_G2F_MegaLMM_GrainYield
# =================================================================
...
sapply(list(Y_Train,Y_Test), head)
# all(is.na(Y_Test))
...
sapply(list(Y,Y_Train,Y_Test), dim)
...
Wea_Dat[1:4,1:6]
unique(Wea_Dat$Year)
unique(sapply(strsplit(colnames(Wea_Dat)[-1*1:5],"::"), "[", 1))
head(Wea_Dat[,c(1:3,which(grepl("GDD",colnames(Wea_Dat))))])
